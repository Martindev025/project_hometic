...
return [
    ...
    'general' => [
        ...
        'you' => 'Estamos trabajando para ti',
    ...
    'header' => [
        ...
        'about' => 'Acerca de nosotros',
            'our' => 'Nuestros Servicios ',
                ...
                'archiv' => 'Organización y clasificación de archivos',
                'cust' => 'Custodia de archivos',
                'digital' => 'Servicios de preservación digital',
                'soft-doc' => 'Software de gestión documental',
                'soft-dig' => 'Software de preservación digital',
                'service' => 'Servicio Archivístico',
                'desktop' => 'Aprovisionamiento de Equipos de Computo',
                'support-desk' => 'Soporte y mantenimiento de equipos',
                'help' => 'Servicio de mesa de ayuda',
                'wem' => 'Desarrollo de software bajo WEM',
                'monitor' => 'TEC-TRACKER',
                'itsm' => 'Herramientas ITSM',
                'cloud' => 'Servicios de backup en la nube',
    ...
    'home' => [
        ...
        'about' => 'Acerca de nosotros',
            ...
            públicas y privadas</span>, anticipándonos al futuro y creando escenarios idóneos para gestionar la información de manera física y virtual.',

        'our' => 'Nuestros Servicios',
            'our-subtitle' => 'Software de gestión documental',
                'our-text' => 'Ofrecemos el Software Jonas SGDEA, un aplicativo web desarrollado en las versiones más recientes de los lenguajes PHP, JQuery, CSS3, entre otras librerías. Utiliza bases de datos como PostgreSQL, lo que lo convierte en un sistema de gestión de base de datos relacional orientado a objetos y de código abierto.',
            'our-subtitle-2' => 'Software de preservación digital',
                'our-text-2' => 'Realizamos un conjunto de acciones y estándares aplicados a los documentos durante su gestión para garantizar su preservación en el tiempo, independientemente de su medio y forma de registro o almacenamiento. Teniendo en cuenta que la preservación a largo plazo es uno de los 8 procesos archivísticos tal como lo indica el Decreto 2609 de 2012 en su artículo 9.',

        'other' => 'Otros Servicios',
            'other-text' => 'Consultoría en gestión documental',
            'other-text-2' => 'Organización y clasificación de archivos',
            'other-text-3' => 'Custodia de archivos',
    ...
    'contact' => [
        ...
        'title-page' => 'Estamos disponibles para tí.',
    ],
    ...
    'us' => [
        ...
        'norma' => 'Cumplimiento Normativo',
            'norma-text' => 'Garantizamos que todos nuestros procesos y servicios cumplan con las normativas vigentes, asegurando la conformidad legal de nuestros clientes.',
    ],
    ...
    'consul' => [
        ...
        'vent' => 'Ventajas',
            'vent-text' => 'Jonas® es una plataforma amigable e intuitiva que facilita la gestión del cambio para los usuarios finales.',
            'vent-text-2' => 'Herramienta para la alta dirección que permite la toma de decisiones, por cuanto entrega en tiempo real información de trámites.',
            'vent-text-3' => 'Los clientes que ya la implementaron han logrado desarrollar sus procesos misionales y de apoyo a la gestión en forma efectiva, sin imprimir documentos físicos, que reduce costos y aumenta la productividad',
            'vent-text-4' => 'Servicios relacionados con todas las áreas de la organización y los funcionarios directamente responsables de la gestión.',
        'vent-final' => 'Jonas® es una plataforma amigable con el medio ambiente contribuyendo a construir el país.',

        'more' => '¿Quieres saber mas?',
            'more-text' => 'Obtén más información sobre nuestros servicios y cómo podemos ayudarte a gestionar y preservar tu documentación de manera eficiente.',
            'more-down' => 'Descargar Brochure',
    ],
    ...
    'preserv' => [
        'title' => 'Servicios de Preservación Digital',
    ],
    ...
    'soft-pre' => [
        ...
        'principal' => 'Características principales',
            'principal-subtitle' => 'Almacenamiento Seguro',
                'principal-text' => 'Protege tus documentos con nuestros sistemas de seguridad avanzados.',
            'principal-subtitle-2' => 'Control de Versiones',
                'principal-text-2' => 'Mantén un historial completo de versiones para facilitar la recuperación de información.',
            'principal-subtitle-3' => 'Automatización de Flujos de Trabajo',
                'principal-text-3' => 'Simplifica procesos mediante la automatización, desde la captura hasta la preservación.',
            'principal-subtitle-4' => 'Indexación y Búsqueda Avanzada',
                'principal-text-4' => 'Encuentra rápidamente los documentos que necesitas con nuestras herramientas de búsqueda y clasificación.',
            'principal-subtitle-5' => 'Cumplimiento Normativo',
    ...
    'aprov-desk' => [
        'title' => 'Aprovisionamiento de Equipos de Computo',
    ],

    'desktop' => [
        'title' => 'Soporte y Mantenimiento de Equipos',

        'hard-soft' => 'Hardware y Software',
            'hard-soft-text' => 'Proveemos todos los servicios de hardware y software que tu o tu empresa requieran, con nosotros podrás encontrar:
                            <br>
                            - Equipos de cómputo
                            <br>
        ...
        'inno' => 'Innovación Tecnológica',
            'inno-text' => 'Manejamos muchas zonas en las que innovamos la industria, así como lo son los escritorios virtuales, los que nos permiten a los usuarios ejecutar un sistema operativo o aplicación dentro de un servidor, sistema hiperconvergente o nube, trabajando desde cualquier lugar, minimizando su inversión.',
    ...
    'help' => [
        ...
        'help' => 'Mesa De Ayuda',
            'help-text' => 'Buscamos dar soporte a diferentes niveles de usuarios de una empresa y debe proveer a los usuarios un punto central para brindar ayuda en varios temas.
                        <br>
                        Este servicio se puede ofrecer en diferentes zonas horarias e idiomas para garantizar la continuidad del negocio en todas sus ubicaciones junto con la automatización de procesos.',
        ...
        'support' => 'Soporte Remoto',
            'support-text' => 'Con este servicio evitará la ejecución de gastos innecesarios, infraestructura remotamente de manera segura.',
            'support-text-2' => 'Vía VPN u otra alternativa autorizada por nuestros clientes, tenemos la capacidad de gestionar',
    ...
    'wem' => [
        ...
        'aplications' => 'Cree aplicaciones empresariales de misión crítica a una velocidad increíble',
    ...
    'back' => [
        ...
        '321' => 'La regla 3-2-1 de copia de seguridad de Acronis',
            '321-text' => 'Acronis Cloud Storage es una suscripción a la nube sencilla que convierte a Acronis Cyber Protect en una potente solución de copia de seguridad híbrida que permite implementar fácilmente copias de seguridad locales seguras y externas escalables para cualquier carga de trabajo o sistema, en cualquier momento y lugar.',
    ],
    ...
    'partners' => [
        ...
        'part' => 'ALIADOS',
            'part-text' => 'Estos son nuestros más fieles aliados.',
    ],
	...
	'request' => [
        ...
        'generate' => 'Genere su Solicitud',
        'consult' => 'Consulte su Solicitud',
        'pqr' => 'Registre su PQR',
    ],
];
