...
<div
  ...
  style="background-image: url('{{ asset('assets/img/background-index.png') }}')"
>
    ...
    <div class="row justify-content-center mt-5 text-center">
      <div class="container">
        <div class="row justify-content-center pb-5">
          <div class="col">
            <h3 class="text-h3 mb-3">{{ __('validation.cust.promise') }}</h3>
            <p class="text-p mb-3">{{ __('validation.cust.dedication') }}</p>
          </div>
        </div>
