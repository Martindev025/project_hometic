    ...
    <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
            <div class="col-lg-8">
                ...
                <h1 class="fg-white text-center"><?php echo e(__('validation.cust.title')); ?></h1>
            </div>
        </div>
    </div>
</div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hometic\resources\views/custodia.blade.php ENDPATH**/ ?>