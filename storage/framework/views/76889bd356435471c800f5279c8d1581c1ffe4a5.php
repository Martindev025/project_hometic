...
<div class="banner-container-acerca">
    ...
    <div class="banner-title-acerca">
      <?php echo trans('validation.consul.title'); ?> 
   </div>
</div>
...
<section class="gestion-documental">
        <div class="documental">
            <div class="texto">
                <h2><?php echo e(__('validation.consul.what')); ?></h2>
                <div class="linea"></div>
                <p><?php echo e(__('validation.consul.what-text')); ?></p>
            </div>
            <img src="<?php echo e(asset('assets/img/software-gestion.png')); ?>" alt="Software de gestión documental">
        </div>
    </section>
...
<section class="jonas-documental">
        <div class="contenedor-documental">
            <img src="<?php echo e(asset('assets/img/jonas-documental.png')); ?>" alt="Acerca de Nosotros">
            <div class="texto-documental">
                <h1><?php echo e(__('validation.consul.sgdea')); ?></h1>
                <div class="linea"></div>
                <p><?php echo e(__('validation.consul.sgdea-text')); ?></p>
            </div>
        </div>
    </section>
  ...
  <h2><?php echo e(__('validation.consul.vent')); ?></h2>
  <div class="ventajas-lista">
    <div class="ventaja-item">
      <span class="numero">1.</span>
      <p><?php echo e(__('validation.consul.vent-text')); ?></p>
    </div>
    <div class="ventaja-item">
      <span class="numero">2.</span>
      <p><?php echo e(__('validation.consul.vent-text-2')); ?></p>
    </div>
    <div class="ventaja-item">
      <span class="numero">3.</span>
      <p><?php echo e(__('validation.consul.vent-text-3')); ?></p>
    </div>
    <div class="ventaja-item">
      <span class="numero">4.</span>
      <p><?php echo e(__('validation.consul.vent-text-4')); ?></p>
    </div>
    <h3><?php echo e(__('validation.consul.vent-final')); ?></h3>
  </div>
</section>
...
<section class="descargar-brochure">
    <div class="contenedor-brochure">
        <h2><?php echo e(__('validation.consul.more')); ?></h2>
        <p><?php echo e(__('validation.consul.more-text')); ?></p>
        <a href="<?php echo e(asset('assets/HT Gestión Documental JONAS SGDEA.pdf')); ?>" class="btn-descargar" download><?php echo e(__('validation.consul.more-down')); ?></a>
    </div>
</section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hometic\resources\views/consultoria.blade.php ENDPATH**/ ?>