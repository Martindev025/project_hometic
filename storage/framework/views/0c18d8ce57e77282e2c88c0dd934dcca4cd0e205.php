...
style="background-image: url('<?php echo e(asset('assets/img/bg_image_3.jpg')); ?>')">
  <div class="container h-100">
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-lg-8">
        ...
        <h1 class="fg-white text-center"><?php echo e(__('validation.partners.title')); ?></h1>
      </div>
    </div>
  </div>
</div>
...
<br>              
                <h2 class="title-section mb-3"><?php echo e(__('validation.partners.part')); ?></h2>
                <p><?php echo e(__('validation.partners.part-text')); ?></p>
            </div>
            <div class="row row-cols-md-3 row-cols-lg-3 justify-content-center text-center">
                <div class="py-3 px-1">
                    <img src="<?php echo e(asset('assets/img/clients/andina-inmobiliaria.png')); ?>" alt=""style="height: 100%; margin: 10px 0px 0px 80px">
                </div>
                <div class="py-3 px-5" style="margin-top: 2%;">
                    <img src="<?php echo e(asset('assets/img/clients/koral.png')); ?>" alt="" style="height: 100%;">
                </div>
                <div class="py-3 px-5">
                    <img src="<?php echo e(asset('assets/img/clients/andina-life.png')); ?>" alt="">
                </div>
                <div class="py-3 px-1">
            ...
            <div class="py-3 px-1">
                <img src="<?php echo e(asset('assets/img/clients/dinamica.png')); ?>" alt="" style= "width: 60%; height: 45%; margin: 40px 0px 0px 20px;">
            </div>
            <div class="py-3 px-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hometic\resources\views/aliados.blade.php ENDPATH**/ ?>