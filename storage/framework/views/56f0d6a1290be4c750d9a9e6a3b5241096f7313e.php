  ...
  <div class="container h-100">
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-lg-8">
        ...
        <h1 class="fg-white text-center"><?php echo e(__('validation.contact.title-page')); ?></h1>
      </div>
    </div>
  </div>
</div> <!-- .page-banner -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hometic\resources\views/contacto.blade.php ENDPATH**/ ?>