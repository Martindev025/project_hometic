    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('cotizacion.store')); ?>" class="form-contact" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 py-2">
                    <label for="number" class="fg-grey">Numero de telefono</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\dev\laravel\allgroup-app\resources\views/monitor.blade.php ENDPATH**/ ?>