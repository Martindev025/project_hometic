                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <a href="consultory.php" class="dropdown-item">
                                ...
                                <div class="dropdown-divider"></div>
                                <a href="archivistico.php" class="dropdown-item">
                                Servicio Archivistico
                                    <span class="float-right text-muted text-sm"></span>
                                </a>
                                <div class="dropdown-divider"></div>
                                <a href="aprovisionamiento.php" class="dropdown-item">
                                Aprovicionamiento de Equipos de Computo
                                    <span class="float-right text-muted text-sm"></span>
                                </a>
                                <div class="dropdown-divider"></div>
                                ...
                                <div class="dropdown-divider"></div>
                                <a href="wem.php" class="dropdown-item">
                                Desarrollo de software bajo WEM
                                    <span class="float-right text-muted text-sm"></span>
                                </a>
                                <div class="dropdown-divider"></div>
                                ...
                                <div class="dropdown-divider"></div>
                                <a href="itsm.php" class="dropdown-item">
                                Herramientas ITSM
                                    <span class="float-right text-muted text-sm"></span>
                                </a>
                                <div class="dropdown-divider"></div>
...
-->
    ...
    <div class="page-banner bg-img bg-img-parallax overlay-dark" style="background-image: url(assets/img/fondo-pestañas.jpg)">
...
<div class="page-section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 py-3">
                <div class="about-img">
                    <img class="img32" src="assets/img/nube-bg.jpg" alt="">
                </div>
            </div>
        </div>
    </div> <!-- .container -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 py-3">
                <div class="about-img1">
                    <img class="img32" src="assets/img/wem.png" alt="" style="width: 100%";>
                </div>
            </div>
            <div class="col-lg-6 py-3">
                ...
                <p style="text-align: justify">Regístrese hoy para obtener una cuenta WEM gratuita
                    ...
                    avanzados de desarrollo e integración en varios formatos
                    y geografías.</p>
            </div>
        </div>
    </div>
